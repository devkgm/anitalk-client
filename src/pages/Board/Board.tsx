                    ...
                    <div className={styles.commentSection}>
                        ...
                        <ul className={styles.comments}>
                            {comments.map((comment) => (
                                <li className={styles.commets_item} key={comment.id + comment.writeDate}>
                                    ...
                                    {isLoggedIn && comment.userId === user.id && (
                                        <div className={styles.edit}>
                                            <div className={styles.delete} onClick={() => handleDeleteComment(comment)}>
                                                삭제
                                            </div>
                                            <div className={styles.reply} onClick={() => console.log('답글')}>
                                                답글
                                            </div>
                                        </div>
                                    )}
